...
var arraylist = ["8", "9", "3"];
function testStringsEquality(param1, result) {
  return param1 === result ? "true result" : "false result";
}

function testStringsEqualityWithLowerCase(param1, result) {
...
function numericalTestwithEquality(param1, result) {
  return param1 === result ? "true result" : "false result";
}
console.log(numericalTestwithEquality(1, 1));
console.log(numericalTestwithEquality(1, 2));

function numericalTestwithGreatorThanAndLessThan(param1, result) {
...
function testItemNotInArray(number) {
